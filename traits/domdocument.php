...
trait DOMDocument
{
	...
	{
		return $this->ownerDocument->createAttributeNS($namespaceURI, $qualifiedName);
	}
	...
	{
		return $this->ownerDocument->createCDATASection($string);
	}
	...
	{
		return $this->ownerDocument->createElement($name, $vaue);
	}
	...
	{
		return $this->ownerDocument->createElementNS($namespaceURI, $qualifiedName, $value);
	}
	...
	{
		return $this->ownerDocument->createEntityReference($name);
	}
	...
	{
		return $this->ownerDocument->createProcessingInstruction($target, $data);
	}
	...
	{
		return $this->ownerDocument->getElementByID($elementID);
	}
	...
	{
		return $this->ownerDocument->importNode($node, $deep);
	}
}
